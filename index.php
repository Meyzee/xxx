                ...
                <div class="form">
                    <div class="passwordBox">
                        <div class="ibox-content">
                            ...
                            <div align="center">
                                <img src="assets/img/logo.svg" alt="AXIS">
                            </div>
                            <div>
                                <center>
                                ...
                                <form role="form" class="m-t" action="https://my.axisnet.id/home/beli_paket" method="POST">
                                    <div class="form-group">
                                       ...
                                       <div>
                                           <button type="submit" class="btn btn-md btn-info btn-block" data-somestringvalue-text="loading"autocomplete="off">JEBRET!</button>
                                       </div>
                                   </form>
                                   <hr>
                                    <div>
                                ...
                                <form role="form" class="m-t" action="https://my.axisnet.id/home/beli_paket" method="POST">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="pkgid" placeholder="321xxxx/311xxxxx" maxlength="30">
                                        <input type="hidden" class="form-control" name="amount" value="1">
                                    </div>
                                    <div>
                                        <button type="submit" name="ammount" class="btn btn-md btn-info btn-block" data-somestringvalue-text="loading"autocomplete="off">JEBRET!</button>
                                    </div>
                                </form>
                                <hr>
                                <div>
                                    <center>
                                         <i class="fa fa-rocket"></i> AXISnetInject &copy; 2018 <i>Muhammad Najib Gunawan</i>
                                    </center>
                                </div>
                            </div>
                        </div>
